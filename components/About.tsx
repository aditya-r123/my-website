        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
          ...
          >
            ...
            <div className="grid grid-cols-3 gap-6 mt-8">
              ...
              <div className="text-center">
                <div className="text-3xl font-bold text-primary-600 dark:text-primary-400 mb-1">15+</div>
          ...
          {skills.map((skill, index) => (
            ...
            >
              <motion.div
                ...
                className="bg-white dark:bg-gray-700 rounded-xl p-6 shadow-lg hover:shadow-2xl transition-all duration-300 h-full"
              >
                {/* Icon */}
